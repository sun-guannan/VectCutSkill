# image 端点规则（get_intro_animation_types / get_outro_animation_types / get_combo_animation_types / add_image）

## 适用范围
- `GET /cut_jianying/get_intro_animation_types`
- `GET /cut_jianying/get_outro_animation_types`
- `GET /cut_jianying/get_combo_animation_types`
